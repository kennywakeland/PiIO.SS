...
#        'NAME': 'db-1.sqlite3',                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = os.path.join(PROJECT_ROOT, MEDIA_URL.lstrip("/")).replace("\\","/")
...
SECRET_KEY = '%#8!c=_xz71j63t82+m(p^+)dyne(iqky7a-97un!3i91#qs~*'
